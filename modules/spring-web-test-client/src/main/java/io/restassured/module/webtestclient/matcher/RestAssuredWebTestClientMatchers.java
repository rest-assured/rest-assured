...
public class RestAssuredWebTestClientMatchers {
	 ...
	 */
	public static ResponseAwareMatcher<WebTestClientResponse> equalToPath(final String path) {
	 ...
	 * @return A {@link ResponseAwareMatcher}
	 */
	public static ResponseAwareMatcher<WebTestClientResponse> endsWithPath(final String path) {
	 ...
	 * @return A {@link ResponseAwareMatcher}
	 */
	public static ResponseAwareMatcher<WebTestClientResponse> startsWithPath(final String path) {
	 ...
	 * @return A {@link ResponseAwareMatcher}
	 */
	public static ResponseAwareMatcher<WebTestClientResponse> containsPath(final String path) {
