...
/**
 * Converts update strategies between MockMvc and vanilla REST Assured
 */
class UpdateStrategyConverter {

    static ParamConfig.UpdateStrategy convert(MockMvcParamConfig.UpdateStrategy updateStrategy) {
