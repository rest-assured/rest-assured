...
public interface Filter {
     ...
     * You need to call {@link FilterContext#next(com.jayway.restassured.specification.FilterableRequestSpecification, com.jayway.restassured.specification.FilterableResponseSpecification)} when you're done otherwise the request will not be delivered.
     ...
     * @param ctx The filter context. You need to call {@link FilterContext#next(com.jayway.restassured.specification.FilterableRequestSpecification, com.jayway.restassured.specification.FilterableResponseSpecification)} when you're done otherwise the request will not be delivered.
     * @return The response
     *
     */
