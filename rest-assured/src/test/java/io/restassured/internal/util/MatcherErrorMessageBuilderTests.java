...
public class MatcherErrorMessageBuilderTests {
    ...
    public void shouldIncludeMismatchedDescription() {
        ...
        final TypeSafeMatcher<Integer> matcher = new TypeSafeMatcher<>() {
            @Override
        ...
        final MatcherErrorMessageBuilder<Integer, Matcher<Integer>> builder = new MatcherErrorMessageBuilder<>("status code");
        final String error = builder.buildError(500, matcher);

        assertThat(error).isEqualTo("Expected status code to equal <200> but was <500> with body: There was an error.\n");
    }
    ...
    public void shouldPrintNicelyWithoutMismatchDescription() {
        ...
        assertThat(error).isEqualTo("Expected status code to equal <200> but was <500>.\n");
    }
    ...
    public void shouldPrintNicelyWithDefaultEqualMatcher() {
        ...
        assertThat(error).isEqualTo("Expected status code <200> but was <500>.\n");
    }
}
