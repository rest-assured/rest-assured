...
## News 
* 2017-10-05: REST Assured [3.0.5](http://dl.bintray.com/johanhaleby/generic/rest-assured-3.0.4-dist.zip) is released. It reverts an accidental change to the API that turned out to be binary incompatible (only source compatible). Sorry!
...
* [Javadoc](http://www.javadoc.io/doc/io.rest-assured/rest-assured/3.0.5)
* [Rest Assured Javadoc](http://static.javadoc.io/io.rest-assured/rest-assured/3.0.5/io/restassured/RestAssured.html)
* [Rest AssuredMockMvc Javadoc](http://static.javadoc.io/io.rest-assured/spring-mock-mvc/3.0.5/io/restassured/module/mockmvc/RestAssuredMockMvc.html)
* [XmlPath Javadoc](http://static.javadoc.io/io.rest-assured/xml-path/3.0.5/io/restassured/path/xml/XmlPath.html)
* [JsonPath Javadoc](http://static.javadoc.io/io.rest-assured/json-path/3.0.5/io/restassured/path/json/JsonPath.html)
