...
## News 
* 2015-11-06: [Documentated](https://github.com/jayway/rest-assured/wiki/Usage#kotlin) on integrate [Kotlin](https://kotlinlang.org/) a bit nicer with REST Assured. Refer to [this](http://tech.haleby.se/2015/11/06/rest-assured-with-kotlin/) blog for additional info and example.
