...
/**
 * XmlPath is an alternative to using XPath for easily getting values from an XML document. It follows the Groovy <a href="http://docs.codehaus.org/display/GROOVY/GPath">GPath</a> syntax
 * described <a href="http://docs.codehaus.org/display/GROOVY/Updating+XML+with+XmlSlurper">here</a>. <br>Let's say we have an XML defined as;
 * <pre>
 * &lt;shopping&gt;
...
public class XmlPath {
     ...
     * <a href="http://docs.codehaus.org/display/GROOVY/Updating+XML+with+XmlSlurper">this</a> url.
     *
